...
def evaluateWindow(window, piece): #window: A Line of four piece, connected either Horicontal, vertical or diagonal
	score = 0
	...
	if window.count(enemyPiece) == 3 and window.count(EMPTY) == 1: # Attention Needed, Hat manchmal Aussete, muss wohl noch hoch
		score -= scorecard[3]
